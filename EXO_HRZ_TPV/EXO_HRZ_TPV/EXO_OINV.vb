...
#Region "Campos identificación del cobro"
            ...
            oItem.FromPane = 0
            oItem.ToPane = 0
            CType(oItem.Specific, SAPbouiCOM.EditText).DataBind.SetBound(True, "OINV", "U_EXO_CDOCENTRY")
            ...
            oItem.ToPane = 0
            oItem.Enabled = False
            CType(oItem.Specific, SAPbouiCOM.EditText).DataBind.SetBound(True, "OINV", "U_EXO_CDOCNUM")
            oItem.SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, SAPbouiCOM.BoAutoFormMode.afm_Find, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            oItem.SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, SAPbouiCOM.BoAutoFormMode.afm_Add, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            oItem.SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, SAPbouiCOM.BoAutoFormMode.afm_Ok, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            ...
            oItem.Enabled = False
            CType(oItem.Specific, SAPbouiCOM.ComboBox).DataBind.SetBound(True, "OINV", "U_EXO_CTIPO")
            oItem.SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, SAPbouiCOM.BoAutoFormMode.afm_Find, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            oItem.SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, SAPbouiCOM.BoAutoFormMode.afm_Add, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            oItem.SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, SAPbouiCOM.BoAutoFormMode.afm_Ok, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
...
#End Region
    ...
    Private Function EventHandler_ItemPressed_After(ByRef pVal As ItemEvent) As Boolean
        ...
        Try
            ...
            oForm = objGlobal.SBOApp.Forms.Item(pVal.FormUID)
            Dim sDocEntryDoc As String = oForm.DataSources.DBDataSources.Item("OINV").GetValue("DocEntry", 0).ToString
            sSQL = "SELECT ""U_EXO_CDOCENTRY"" FROM OINV Where ""DocEntry""=" & sDocEntryDoc
            Dim sDocEntry As String = objGlobal.refDi.SQL.sqlStringB1(sSQL)
            sSQL = "SELECT ""U_EXO_CDOCNUM"" FROM OINV Where ""DocEntry""=" & sDocEntryDoc
            ...
            Select Case pVal.ItemUID
                Case "btnCOBROT"
                    If pVal.ActionSuccess = True Then
                        ...
                        End If
                    Else
                        sMensaje = "Esta Factura ya tiene un cobro asignado. Por favor, primero cancele el cobro."
    ...
    Public Function CargarFormCOBROT(ByRef oFormODLN As SAPbouiCOM.Form, ByVal sTipo As String) As Boolean
        ...
        Try
            ...
            oFP.XmlData = objGlobal.leerEmbebido(Me.GetType(), "EXO_COBROTF.srf")
